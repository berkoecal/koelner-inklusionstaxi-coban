...
const timelineEvents = [
  {
    ...
    description: "Beginn unserer Mission für barrierefreie Mobilität mit zwei spezialisierten Fahrzeugen.",
    details:
  ...
  },
  {
    ...
    description: "Einführung unserer benutzerfreundlichen Online-Buchungsplattform und mobilen App.",
    details:
    ...
    <section ref={containerRef} className="py-20 bg-background overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-4 text-lg text-muted-foreground">Die Entwicklung von MobilPlus im Laufe der Jahre</p>
        </motion.div>
